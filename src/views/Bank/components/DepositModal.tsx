    ...
    <Modal>
      ...
      />
        ...
        <div style={{ display: 'flex' }}>
          {numNodes.map((num, i) => {
            return (<>
              <Button data-tip={`${getDisplayBalance(nodePrice.mul(num), 18, 0)} EMP`} style={{ whiteSpace: 'nowrap', marginRight: i === numNodes.length - 1 ? '0' : '1rem' }} className="shinyButtonSecondary" onClick={() => onConfirm(num.toString())}>
